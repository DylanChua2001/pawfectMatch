...
const s3Controller = {
    uploadImage : async (req, res) => {
        ...
        try{    
            ...
            */
            ...
            const updateResponse = await fetch(`https://pawfect-match-three.vercel.app/api/users/uploadUserImageID/${userID}`, {
                method: 'PUT',
                headers: {
    ...
    displayImage : async (req, res) => {
        ...
        try {
            ...
            const responsePhoto = await fetch(`https://pawfect-match-three.vercel.app/api/users/retrieveUserImageID/${userID}`, {
                method: 'GET',
            });
    ...
    uploadPetImage : async (req, res) => {
        ...
        try{    
            ...
            */
            ...
            const updateResponse = await fetch(`https://pawfect-match-three.vercel.app/api/pets/uploadPetImageID/${petID}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    displayPetImage : async (req, res) => {
        ...
        try {
            ...
            const responsePhoto = await fetch(`https://pawfect-match-three.vercel.app/api/pets/retrievePetImageID/${petID}`, {
                method: 'GET',
            });
    ...
    uploadTrainingImage : async (req, res) => {
        ...
        try{    
            ...
            */
            ...
            const updateResponse = await fetch(`https://pawfect-match-three.vercel.app/api/trainPack/uploadTrainingImageID/${trainID}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    displayTrainingImage : async (req, res) => {
        ...
        try {
            ...
            const responsePhoto = await fetch(`https://pawfect-match-three.vercel.app/api/trainPack/retrieveTrainingImageID/${trainID}`, {
                method: 'GET',
            });
