...
const AddPet = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const createPetResponse = await axios.post('https://pawfect-match-three.vercel.app/api/pets/createPet', formData, {
      ...
      if (formData.mainPhoto) {
        ...
        const uploadImageResponse = await axios.post(`https://pawfect-match-three.vercel.app/api/image/uploadPetImage/${createPetResponse.data.pet_id}`, formDataImage, {
          headers: {
