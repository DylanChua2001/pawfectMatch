...
const TrainingPackageProfile = ({ trainingPackage, onAddToCart }) => {
  ...
  const handleLikeButtonClick = async () => {
    const url = liked
      ? `https://pawfect-match-three.vercel.app/api/favourites/deleteFavTrainPack/${sessionID}/delete/${trainingPackage.train_id}`
      : `https://pawfect-match-three.vercel.app/api/favourites/addFavTrainPack/${sessionID}/add/${trainingPackage.train_id}`;
  ...
  const handleDelete = async () => {
    try {
      ...
      const response = await axios.delete(`https://pawfect-match-three.vercel.app/api/trainPack/deleteTrainingPack/${trainingPackage.train_id}`, {
