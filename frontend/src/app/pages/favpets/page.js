...
const FavPetsPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchFavoritePetIds = async () => {
      try {
        const response = await axios.get(`https://pawfect-match-three.vercel.app/api/favourites/getAllFavPets/${userID}`);
  ...
  useEffect(() => {
    const fetchPetDetails = async () => {
      try {
        const response = await axios.get('https://pawfect-match-three.vercel.app/api/pets/getAllPets');
