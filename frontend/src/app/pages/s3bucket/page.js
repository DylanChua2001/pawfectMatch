...
function s3Page() {  
    ...
    const userPhotosubmit = async (event) => {
        ...
        try {
            const response = await axios.post(`https://pawfect-match-three.vercel.app/api/image/uploadImage/${userID}`, formData, {
    ...
    const petPhotosubmit = async (event) => {
        ...
        try {
            const response = await axios.post(`https://pawfect-match-three.vercel.app/api/image/uploadPetImage/${petID}`, formData, {
                headers: { 'Content-Type': 'multipart/form-data' }
            });
    ...
    const trainingPhotosubmit = async (event) => {
        ...
        try {
            const response = await axios.post(`https://pawfect-match-three.vercel.app/api/image/uploadTrainingImage/${trainID}`, formData, {
                headers: { 'Content-Type': 'multipart/form-data' }
            });
